...
class GlobalProperties(context: Context) {
    ...
    enum class PropertiesInt {
        ...
        AUDIO_VOLUME_SLOT2,
        MICROPHONE_VOLUME_SLOT2,
        SHIZUKU_PHONE_CALL_VOLUME_SLOT2,
        AUDIO_VOLUME_SLOT3,
        MICROPHONE_VOLUME_SLOT3,
        SHIZUKU_PHONE_CALL_VOLUME_SLOT3,
        AUDIO_VOLUME_SLOT4,
        MICROPHONE_VOLUME_SLOT4,
        SHIZUKU_PHONE_CALL_VOLUME_SLOT4,
        VOLUME_SLOT_CHOSEN,
